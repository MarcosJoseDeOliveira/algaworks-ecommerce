...
insert into pagamento (pedido_id, status, tipo_pagamento, numero_cartao, codigo_barras, data_vencimento) values (3, 'RECEBIDO', 'boleto', '8910', null, date_sub(sysdate(), interval 2 day));
insert into pagamento (pedido_id, status, tipo_pagamento, numero_cartao, codigo_barras) values (4, 'PROCESSANDO', 'cartao', '1112', null);
insert into pagamento (pedido_id, status, tipo_pagamento, numero_cartao, codigo_barras, data_vencimento) values (6, 'PROCESSANDO', 'boleto', '456', null, date_add(sysdate(), interval 2 day));

insert into nota_fiscal (pedido_id, xml, data_emissao) values (2, '<xml />', sysdate());

insert into categoria (id, nome, categoria_pai_id) values (1, 'Eletrodomésticos', 1);
insert into categoria (id, nome, categoria_pai_id) values (2, 'Livros', 2);
insert into categoria (id, nome, categoria_pai_id) values (3, 'Esportes', 3);
insert into categoria (id, nome, categoria_pai_id) values (4, 'Futebol', 4);
insert into categoria (id, nome, categoria_pai_id) values (5, 'Natação', 5);
insert into categoria (id, nome, categoria_pai_id) values (6, 'Notebooks', 6);
insert into categoria (id, nome, categoria_pai_id) values (7, 'Smartphones', 7);
insert into categoria (id, nome, categoria_pai_id) values (8, 'Câmeras', 8);
